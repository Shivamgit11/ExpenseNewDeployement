...
const forgotpassword = async (req, res) => {
  try {
    ...
    if (user) {
      ...
      //   html: `<a href="http://54.82.231.244:3000/password/resetpassword/${id}">Reset password</a>`,
      // };
      // console.log(msg);
  ...
  <a href="http://54.82.231.244:3000/password/resetpassword/${id}">Reset password</a>,
  `,
          html: `<a href="http://54.82.231.244:3000/password/resetpassword/">Reset password</a>`,
        })
        .then(console.log)
        .catch(console.log);
